...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Создаем/обновляем компании-подрядчики с updateOrCreate
        $this->command->info('🏢 Создание/обновление компаний-подрядчиков...');
        ...
        // Подрядчик 4
        $contractor4 = Contractor::updateOrCreate(
            ['contractor_code' => 'LDS'],
            [
        ...
        $this->command->info('✅ Подрядчики созданы/обновлены');
        ...
        $contractorAdmin = User::firstOrCreate(
        ...
        if (!$contractorAdmin->hasRole('contractor_admin')) {
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            if (!$user->hasRole('contractor_executor')) {
